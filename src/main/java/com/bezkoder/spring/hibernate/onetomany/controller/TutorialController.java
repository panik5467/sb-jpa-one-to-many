...
public class TutorialController {
  ...
  public ResponseEntity<Tutorial> createTutorial(@RequestBody Tutorial tutorial) {
    Tutorial _tutorial = tutorialRepository.save(new Tutorial(tutorial.getTitle(), tutorial.getVersion()));
  ...
  public ResponseEntity<List<Tutorial>> findByVersion(@PathVariable("version") String version) {
    List<Tutorial> tutorials = tutorialRepository.findByVersion(version);
